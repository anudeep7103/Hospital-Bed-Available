...
<head>
    ...
    <div class="features-boxed">
        <div class="container">
            <div class="intro">
                <h2 class="text-center" style="margin-top: 70px;color:black">HOSPITAL DASHBOARD </h2>
            </div>
            <div class="row justify-content-center features">
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div style ="background-color: rgb(146, 168, 209);" class="box"><i class="fa fa-heart icon"></i>
                   
                        <h3 class="name"> Oxygen Cylinders: <?php echo $rec;?> </h3>
                ...
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    ...
                    <div style ="background-color: rgb(146, 168, 209);" class="box"><i class="fa fa-bed icon"></i>
                        <h3 class="name"> Beds Available : <?php echo $admit;?> </h3>
                ...
                <div class="col-sm-6 col-md-5 col-lg-4 item">
                    <div style ="background-color: rgb(146, 168, 209);"class="box"><i class="fa fa-ambulance icon"></i>
                        <h3 class="name">Remedesivir Injections : <?php echo $dec;?> </h3>
